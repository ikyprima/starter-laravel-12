...
class LsExport implements FromArray, WithTitle, WithHeadings, WithStyles, WithCustomStartCell, WithEvents
{
    protected $data;
    protected $meta;
    ...
    {
        return 'Transaksi LS ' . $this->meta['bulan_name'];
    }
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function (AfterSheet $event) {
                ...
                // 1. Setup Header Info
                $sheet->setCellValue('A1', 'DAFTAR TRANSAKSI PAJAK LS');
