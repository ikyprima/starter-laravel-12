...
<template>
    ...
    >
        ...
        <div v-if="activeYear" class="flex flex-col items-end leading-none">
            <span class="text-[10px] font-semibold text-muted-foreground uppercase tracking-wider">Tahun Anggaran</span>
            <span class="text-sm font-bold text-foreground">{{ activeYear }}</span>
        </div>
    </header>
</template>
